...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9e1db7def4097e6283675c6dfd380747) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_ccopt =
                        [
                           (OASISExpr.EBool true, ["-O3"; "-Wall"; "-ggdb"]);
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ci.ml"; });
               Test
                 ({
                     cs_name = "ci";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      test_run =
                        [
                           ...
                           (OASISExpr.EFlag "tests", false);
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "tests", OASISExpr.EFlag "ci"),
                             true)
                        ];
     ...
     oasis_version = "0.3.0~rc2";
     oasis_digest = Some "mD9\155\233\017w\030}.\016f7\211Y3";
     oasis_exec = None;
