...
(* OASIS_START *)
(* DO NOT EDIT (digest: 717366598bbd2b3aad97ae6fd0c2214a) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          ocaml_version =
            Some
              (OASISVersion.VAnd
                 (OASISVersion.VGreaterEqual "4.02.1",
                   OASISVersion.VLesser "4.08.0"));
          version = "1.6";
          license =
          ...
          homepage = Some "https://pdonadeo.github.io/ocaml-lua/";
          bugreports = None;
          ...
          description =
            Some
              [
                 ...
                 OASISText.Para "[Lua homepage](http://www.lua.org/)"
              ];
          tags = [];
          categories = [];
          files_ab = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/pdonadeo/ocaml-lua.git";
                      src_repo_browser =
                        Some "https://github.com/pdonadeo/ocaml-lua";
     ...
     oasis_digest = Some "\223\178Z7;\022\028\230\149\t\019\189c\179\167\160";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
