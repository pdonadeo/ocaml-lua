...
(* OASIS_START *)
(* DO NOT EDIT (digest: d004f1aa89765f6d4ecf4d030959bf47) *)
(*
...
# 21 "/tmp/oasis-0.2.0/src/oasis/OASISContext.ml"
...
# 21 "/tmp/oasis-0.2.0/src/oasis/OASISUtils.ml"
...
# 21 "/tmp/oasis-0.2.0/src/oasis/PropList.ml"
...
# 59 "/tmp/oasis-0.2.0/src/oasis/PropList.ml"
  end
...
# 21 "/tmp/oasis-0.2.0/src/oasis/OASISMessage.ml"
...
# 21 "/tmp/oasis-0.2.0/src/oasis/OASISVersion.ml"
...
# 21 "/tmp/oasis-0.2.0/src/oasis/OASISLicense.ml"
...
# 21 "/tmp/oasis-0.2.0/src/oasis/OASISTypes.ml"
...
# 102 "/tmp/oasis-0.2.0/src/oasis/OASISTypes.ml"
...
# 21 "/tmp/oasis-0.2.0/src/oasis/OASISUnixPath.ml"
...
# 21 "/tmp/oasis-0.2.0/src/oasis/OASISSection.ml"
...
# 21 "/tmp/oasis-0.2.0/src/oasis/OASISBuildSection.ml"
  
end

module OASISExecutable = struct
# 21 "/tmp/oasis-0.2.0/src/oasis/OASISExecutable.ml"
...
# 21 "/tmp/oasis-0.2.0/src/oasis/OASISLibrary.ml"
...
# 21 "/tmp/oasis-0.2.0/src/oasis/OASISFlag.ml"
  
end

module OASISPackage = struct
# 21 "/tmp/oasis-0.2.0/src/oasis/OASISPackage.ml"
  
end

module OASISSourceRepository = struct
# 21 "/tmp/oasis-0.2.0/src/oasis/OASISSourceRepository.ml"
  
end

module OASISTest = struct
# 21 "/tmp/oasis-0.2.0/src/oasis/OASISTest.ml"
  
end

module OASISDocument = struct
# 21 "/tmp/oasis-0.2.0/src/oasis/OASISDocument.ml"
...
# 21 "/tmp/oasis-0.2.0/src/base/BaseContext.ml"
...
# 21 "/tmp/oasis-0.2.0/src/base/BaseMessage.ml"
...
# 21 "/tmp/oasis-0.2.0/src/base/BaseFilePath.ml"
...
# 21 "/tmp/oasis-0.2.0/src/base/BaseEnv.ml"
...
# 21 "/tmp/oasis-0.2.0/src/base/BaseExec.ml"
...
# 21 "/tmp/oasis-0.2.0/src/base/BaseFileUtil.ml"
...
# 21 "/tmp/oasis-0.2.0/src/base/BaseArgExt.ml"
...
# 21 "/tmp/oasis-0.2.0/src/base/BaseCheck.ml"
...
# 21 "/tmp/oasis-0.2.0/src/base/BaseOCamlcConfig.ml"
...
# 21 "/tmp/oasis-0.2.0/src/base/BaseStandardVar.ml"
...
# 21 "/tmp/oasis-0.2.0/src/base/BaseFileAB.ml"
...
# 21 "/tmp/oasis-0.2.0/src/base/BaseLog.ml"
...
# 21 "/tmp/oasis-0.2.0/src/base/BaseBuilt.ml"
...
# 21 "/tmp/oasis-0.2.0/src/base/BaseCustom.ml"
...
# 21 "/tmp/oasis-0.2.0/src/base/BaseDynVar.ml"
...
# 21 "/tmp/oasis-0.2.0/src/base/BaseTest.ml"
...
# 21 "/tmp/oasis-0.2.0/src/base/BaseDoc.ml"
...
# 21 "/tmp/oasis-0.2.0/src/base/BaseSetup.ml"
...
# 21 "/tmp/oasis-0.2.0/src/base/BaseDev.ml"
...
# 21 "/tmp/oasis-0.2.0/src/plugins/internal/InternalConfigurePlugin.ml"
...
# 21 "/tmp/oasis-0.2.0/src/plugins/internal/InternalInstallPlugin.ml"
...
# 21 "/tmp/oasis-0.2.0/src/plugins/ocamlbuild/OCamlbuildCommon.ml"
...
# 21 "/tmp/oasis-0.2.0/src/plugins/ocamlbuild/OCamlbuildPlugin.ml"
...
# 21 "/tmp/oasis-0.2.0/src/plugins/ocamlbuild/OCamlbuildDocPlugin.ml"
...
# 21 "/tmp/oasis-0.2.0/src/plugins/custom/CustomPlugin.ml"
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$bench_exec", []))];
     ...
     package =
       {
          oasis_version = "0.1";
          ocaml_version = Some (OASISVersion.VGreaterEqual "3.11.1");
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Create and run benchmark tests";
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_install_dir = "$htmldir/lua";
                      doc_title = "API reference for Lua";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
